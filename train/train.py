...
if __name__ == '__main__':
    ...
    with open('NP-MGDD/datasets/zuhe/train_merged_smiles.txt','w') as train_file:
        for smile in train_smiles:
            train_file.write(smile + '\n')
    with open('NP-MGDD/datasets/zuhe/test_merged_smiles.txt', 'w') as test_file:
        for smile in test_smiles:
            test_file.write(smile + '\n')
            
    smiles = []
    with open('NP-MGDD/datasets/zuhe/train_merged_smiles.txt', 'r') as train_file:
        for line in train_file:
            smiles.append(line.strip())

    vsmiles = []
    with open('NP-MGDD/datasets/zuhe/test_merged_smiles.txt', 'r') as test_file:
    ...
    tconf = TrainerConfig(max_epochs=args.max_epochs, batch_size=args.batch_size, learning_rate=args.learning_rate,
                            ...
                            ckpt_path=f'NP-MGDD/weights/{args.run_name}.pt', block_size=train_dataset.max_len, generate=True)
